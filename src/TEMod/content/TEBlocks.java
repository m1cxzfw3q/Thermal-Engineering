...
//        }};      TODO T6Unit 赶进度中，别急
        ...
        fixedThruster = new FixedThruster("fixed-thruster") {{
            consumeItems(with(Items.pyratite, 5, Items.blastCompound, 5));
        ...
        starshipAssemblerExpandInputSlot = new TEUnitAssemblerModule("starship-assembler-expand-input-module") {{
